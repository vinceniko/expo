...
import abi39_0_0.host.exp.exponent.modules.api.KeyboardModule;
import abi39_0_0.host.exp.exponent.modules.api.PedometerModule;
import abi39_0_0.host.exp.exponent.modules.api.ScreenOrientationModule;
import abi39_0_0.host.exp.exponent.modules.api.ShakeModule;
import abi39_0_0.host.exp.exponent.modules.api.URLHandlerModule;
import abi39_0_0.host.exp.exponent.modules.api.appearance.ExpoAppearanceModule;
import abi39_0_0.host.exp.exponent.modules.api.appearance.ExpoAppearancePackage;
import abi39_0_0.host.exp.exponent.modules.api.cognito.RNAWSCognitoModule;
import abi39_0_0.host.exp.exponent.modules.api.components.datetimepicker.RNDateTimePickerPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.maskedview.RNCMaskedViewPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.picker.RNCPickerPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.slider.ReactSliderPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.gesturehandler.react.RNGestureHandlerModule;
import abi39_0_0.host.exp.exponent.modules.api.components.gesturehandler.react.RNGestureHandlerPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.lottie.LottiePackage;
import abi39_0_0.host.exp.exponent.modules.api.components.maps.MapsPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.svg.SvgPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.viewpager.RNCViewPagerPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.webview.RNCWebViewModule;
import abi39_0_0.host.exp.exponent.modules.api.components.webview.RNCWebViewPackage;
import abi39_0_0.host.exp.exponent.modules.api.components.sharedelement.RNSharedElementModule;
import abi39_0_0.host.exp.exponent.modules.api.components.sharedelement.RNSharedElementPackage;
import abi39_0_0.host.exp.exponent.modules.api.netinfo.NetInfoModule;
import abi39_0_0.host.exp.exponent.modules.api.notifications.NotificationsModule;
import abi39_0_0.host.exp.exponent.modules.api.safeareacontext.SafeAreaContextPackage;
import abi39_0_0.host.exp.exponent.modules.api.screens.RNScreensPackage;
import abi39_0_0.host.exp.exponent.modules.api.viewshot.RNViewShotModule;
import abi39_0_0.host.exp.exponent.modules.test.ExponentTestNativeModule;
import abi39_0_0.host.exp.exponent.modules.universal.ExpoModuleRegistryAdapter;
import abi39_0_0.host.exp.exponent.modules.universal.ScopedModuleRegistryAdapter;
// This is an Expo module but not a unimodule
import abi39_0_0.expo.modules.random.RandomModule;
  ...
  public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
    ...
    if (isVerified) {
      try {
        ...
        nativeModules.add(new NotificationsModule(reactContext, experienceKey, mExperienceProperties));
