...
import abi40_0_0.host.exp.exponent.modules.api.notifications.ScopedNotificationsCategoriesSerializer;
import abi40_0_0.host.exp.exponent.modules.universal.av.SharedCookiesDataSourceFactoryProvider;
import abi40_0_0.host.exp.exponent.modules.universal.notifications.ScopedExpoNotificationCategoriesModule;
import abi40_0_0.host.exp.exponent.modules.universal.notifications.ScopedExpoNotificationPresentationModule;
import abi40_0_0.host.exp.exponent.modules.universal.notifications.ScopedServerRegistrationModule;
import abi40_0_0.host.exp.exponent.modules.universal.notifications.ScopedNotificationScheduler;
import abi40_0_0.host.exp.exponent.modules.universal.notifications.ScopedNotificationsEmitter;
import abi40_0_0.host.exp.exponent.modules.universal.notifications.ScopedNotificationsHandler;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedAccelerometerService;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedGravitySensorService;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedGyroscopeService;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedLinearAccelerationSensorService;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerService;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerUncalibratedService;
import abi40_0_0.host.exp.exponent.modules.universal.sensors.ScopedRotationVectorSensorService;
