...
import abi41_0_0.org.unimodules.core.interfaces.RegistryLifecycleListener;
...
import abi41_0_0.host.exp.exponent.modules.api.notifications.ScopedNotificationsCategoriesSerializer;
import abi41_0_0.host.exp.exponent.modules.universal.av.SharedCookiesDataSourceFactoryProvider;
import abi41_0_0.host.exp.exponent.modules.universal.notifications.ScopedExpoNotificationCategoriesModule;
import abi41_0_0.host.exp.exponent.modules.universal.notifications.ScopedExpoNotificationPresentationModule;
import abi41_0_0.host.exp.exponent.modules.universal.notifications.ScopedServerRegistrationModule;
import abi41_0_0.host.exp.exponent.modules.universal.notifications.ScopedNotificationScheduler;
import abi41_0_0.host.exp.exponent.modules.universal.notifications.ScopedNotificationsEmitter;
import abi41_0_0.host.exp.exponent.modules.universal.notifications.ScopedNotificationsHandler;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedAccelerometerService;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedGravitySensorService;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedGyroscopeService;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedLinearAccelerationSensorService;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerService;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedMagnetometerUncalibratedService;
import abi41_0_0.host.exp.exponent.modules.universal.sensors.ScopedRotationVectorSensorService;
...
public class ExpoModuleRegistryAdapter extends ModuleRegistryAdapter implements ScopedModuleRegistryAdapter {
  ...
  public List<NativeModule> createNativeModules(ScopedContext scopedContext, ExperienceKey experienceKey, Map<String, Object> experienceProperties, RawManifest manifest, List<NativeModule> otherModules) {
