...
import abi41_0_0.expo.modules.firebase.core.FirebaseCoreService;
import abi41_0_0.expo.modules.firebase.core.FirebaseCoreOptions;
...
public class ScopedFirebaseCoreService extends FirebaseCoreService implements RegistryLifecycleListener {
  ...
  public ScopedFirebaseCoreService(Context context, RawManifest manifest, ExperienceKey experienceKey) {
    ...
    mAppName = "__sandbox_" + getEncodedExperienceId(experienceKey);
  ...
  private static String getEncodedExperienceId(ExperienceKey experienceKey) {
    try {
      String encodedUrl = experienceKey.getUrlEncodedStableLegacyId();
      ...
      return Integer.toString(experienceKey.getStableLegacyId().hashCode());
    }
  }
