package abi41_0_0.host.exp.exponent.modules.api.notifications;
...
public class ScopedNotificationsIdUtils {
  ...
  public static String getScopedCategoryId(@NonNull ExperienceKey experienceKey, @NonNull String categoryId) {
    return SCOPED_CATEGORY_TAG + SEPARATOR + experienceKey.getStableLegacyId() + SEPARATOR + categoryId;
  }
