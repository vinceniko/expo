...
public class ErrorRecoveryManager {
  ...
  private static Map<ExperienceKey, ErrorRecoveryManager> sExperienceKeyToManager = new HashMap<>();
  ...
  public static ErrorRecoveryManager getInstance(final ExperienceKey experienceKey) {
    if (!sExperienceKeyToManager.containsKey(experienceKey)) {
      sExperienceKeyToManager.put(experienceKey, new ErrorRecoveryManager(experienceKey));
    }

    return sExperienceKeyToManager.get(experienceKey);
  }
