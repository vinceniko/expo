...
public class DetachedModuleRegistryAdapter extends ExpoModuleRegistryAdapter {
  ...
  @Override
  public List<NativeModule> createNativeModules(final ScopedContext scopedContext, ExperienceKey experienceKey, Map<String, Object> experienceProperties, RawManifest manifest, List<NativeModule> otherModules) {
