...
#import <ABI41_0_0React/ABI41_0_0RCTAutoInsetsProtocol.h>
#import "ABI41_0_0RNCWKProcessPoolManager.h"
#if !TARGET_OS_OSX
#import <UIKit/UIKit.h>
#else
#import <ABI41_0_0React/ABI41_0_0RCTUIKit.h>
#endif // !TARGET_OS_OSX

#import "objc/runtime.h"

static NSTimer *keyboardTimer;
static NSString *const HistoryShimName = @"ABI41_0_0ReactNativeHistoryShim";
...
@interface ABI41_0_0_SwizzleHelperWK : UIView
@property (nonatomic, copy) WKWebView *webView;
@end
@implementation ABI41_0_0_SwizzleHelperWK
...
#if TARGET_OS_OSX
@interface ABI41_0_0RNCWKWebView : WKWebView
@end
@implementation ABI41_0_0RNCWKWebView
- (void)scrollWheel:(NSEvent *)theEvent {
  ABI41_0_0RNCWebView *rncWebView = (ABI41_0_0RNCWebView *)[self superview];
  ABI41_0_0RCTAssert([rncWebView isKindOfClass:[rncWebView class]], @"superview must be an ABI41_0_0RNCWebView");
...
@interface ABI41_0_0RNCWebView () <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler,
#if !TARGET_OS_OSX
    UIScrollViewDelegate,
#endif // !TARGET_OS_OSX
    ABI41_0_0RCTAutoInsetsProtocol>

@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onFileDownload;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onLoadingStart;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onLoadingFinish;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onLoadingError;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onLoadingProgress;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onShouldStartLoadWithRequest;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onHttpError;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onMessage;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onScroll;
@property (nonatomic, copy) ABI41_0_0RCTDirectEventBlock onContentProcessDidTerminate;
#if !TARGET_OS_OSX
@property (nonatomic, copy) WKWebView *webView;
#else
@property (nonatomic, copy) ABI41_0_0RNCWKWebView *webView;
#endif // !TARGET_OS_OSX
...
@implementation ABI41_0_0RNCWebView
{
#if !TARGET_OS_OSX
  UIColor * _savedBackgroundColor;
#else
  ABI41_0_0RCTUIColor * _savedBackgroundColor;
#endif // !TARGET_OS_OSX
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if ((self = [super initWithFrame:frame])) {
    ...
    #else
    super.backgroundColor = [ABI41_0_0RCTUIColor clearColor];
    #endif // !TARGET_OS_OSX
    _bounces = YES;
    _scrollEnabled = YES;
    ...
    #if !TARGET_OS_OSX
    _savedStatusBarStyle = ABI41_0_0RCTSharedApplication().statusBarStyle;
    _savedStatusBarHidden = ABI41_0_0RCTSharedApplication().statusBarHidden;
    #endif // !TARGET_OS_OSX
...
- (WKWebViewConfiguration *)setUpWkWebViewConfig
{
  ...
  [wkWebViewConfig.userContentController addScriptMessageHandler:[[ABI41_0_0RNCWeakScriptMessageDelegate alloc] initWithDelegate:self]
...
#else
    _webView = [[ABI41_0_0RNCWKWebView alloc] initWithFrame:self.bounds configuration: wkWebViewConfig];
#endif // !TARGET_OS_OSX
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI41_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI41_0_0RCTSharedApplication() setStatusBarStyle:self->_savedStatusBarStyle animated:YES];
    });
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    ABI41_0_0RCTUnsafeExecuteOnMainQueueSync(^{
      [ABI41_0_0RCTSharedApplication() setStatusBarHidden:self->_savedStatusBarHidden animated:YES];
      [ABI41_0_0RCTSharedApplication() setStatusBarStyle:self->_savedStatusBarStyle animated:YES];
    });
#pragma clang diagnostic pop
}
...
#else
- (void)setBackgroundColor:(ABI41_0_0RCTUIColor *)backgroundColor
#endif // !TARGET_OS_OSX
{
...
- (void)setContentInset:(UIEdgeInsets)contentInset
{
  ...
  [ABI41_0_0RCTView autoAdjustInsetsForView:self
...
- (void)visitSource
{
    ...
    NSString *html = [ABI41_0_0RCTConvert NSString:_source[@"html"]];
    if (html) {
        NSURL *baseURL = [ABI41_0_0RCTConvert NSURL:_source[@"baseUrl"]];
        if (!baseURL) {
    ...
    // Because of the way ABI41_0_0React works, as pages redirect, we actually end up
    ...
    if (request.URL.host) {
        ...
        NSURL* readAccessUrl = _allowingReadAccessToURL ? [ABI41_0_0RCTConvert NSURL:_allowingReadAccessToURL] : request.URL;
...
-(void)setHideKeyboardAccessoryView:(BOOL)hideKeyboardAccessoryView
{
    ...
    NSString* name = [NSString stringWithFormat:@"%@ABI41_0_0_SwizzleHelperWK", subview.class.superclass];
    ...
    if(newClass == nil)
    {
        ...
        Method method = class_getInstanceMethod([ABI41_0_0_SwizzleHelperWK class], @selector(inputAccessoryView));
...
- (void)postMessage:(NSString *)message
{
  ...
  NSString *source = [NSString
    ...
    ABI41_0_0RCTJSONStringify(eventInitDict, NULL)
  ];
...
- (void)layoutSubviews
{
  ...
  // Ensure webview takes the position and dimensions of ABI41_0_0RNCWebView
...
- (void)webView:(WKWebView *)webView runJavaScriptTextInputPanelWithPrompt:(NSString *)prompt defaultText:(NSString *)defaultText initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(NSString *))completionHandler{
  ...
  const NSRect ABI41_0_0RCTSingleTextFieldFrame = NSMakeRect(0.0, 0.0, 275.0, 22.0);
  NSTextField *textField = [[NSTextField alloc] initWithFrame:ABI41_0_0RCTSingleTextFieldFrame];
...
-(UIViewController *)topViewController{
    return ABI41_0_0RCTPresentedViewController();
}
...
{
  ABI41_0_0RCTLogWarn(@"Webview Process Terminated");
  if (_onContentProcessDidTerminate) {
    NSMutableDictionary<NSString *, id> *event = [self baseEvent];
    _onContentProcessDidTerminate(event);
  }
          ...
          thenCall: (void (^)(NSString*)) callback
{
  [self.webView evaluateJavaScript: js completionHandler: ^(id result, NSError *error) {
    ...
    if (error != nil) {
      ABI41_0_0RCTLogWarn(@"%@", [NSString stringWithFormat:@"Error evaluating injectedJavaScript: This is possibly due to an unsupported return type. Try adding true to the end of your injectedJavaScript string. %@", error]);
    }
  }];
}
      ...
      */
      ...
      for (NSHTTPCookie *cookie in [[NSHTTPCookieStorage sharedHTTPCookieStorage] cookies]) {
        [script appendFormat:@"document.cookie = %@ + '=' + %@",
          ABI41_0_0RCTJSONStringify(cookie.name, NULL),
          ABI41_0_0RCTJSONStringify(cookie.value, NULL)];
        if (cookie.path) {
          [script appendFormat:@" + '; Path=' + %@", ABI41_0_0RCTJSONStringify(cookie.path, NULL)];
        }
...
- (NSURLRequest *)requestForSource:(id)json {
  NSURLRequest *request = [ABI41_0_0RCTConvert NSURLRequest:self.source];
...
@implementation ABI41_0_0RNCWeakScriptMessageDelegate
