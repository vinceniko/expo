...
#import "ABI41_0_0ReactNativePageView.h"
...
@interface ABI41_0_0ReactNativePageView () <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>

@property(nonatomic, strong) UIPageViewController *reactPageViewController;
@property(nonatomic, strong) UIPageControl *reactPageIndicatorView;
@property(nonatomic, strong) ABI41_0_0RCTEventDispatcher *eventDispatcher;
...
@implementation ABI41_0_0ReactNativePageView {
    uint16_t _coalescingKey;
}

- (instancetype)initWithEventDispatcher:(ABI41_0_0RCTEventDispatcher *)eventDispatcher {
    if (self = [super init]) {
        _scrollEnabled = YES;
        _pageMargin = 0;
...
- (void)setReactViewControllers:(NSInteger)index
    ...
    __weak ABI41_0_0ReactNativePageView *weakSelf = self;
