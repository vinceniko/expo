...
- (void)insertReactSubview:(ABI41_0_0RNSScreenStackHeaderSubview *)subview atIndex:(NSInteger)atIndex
{
  [_ABI41_0_0ReactSubviews insertObject:subview atIndex:atIndex];
  subview.ABI41_0_0ReactSuperview = self;
}

- (void)removeReactSubview:(ABI41_0_0RNSScreenStackHeaderSubview *)subview
{
