...
@interface RNSScreenView () <UIAdaptivePresentationControllerDelegate, ABI41_0_0RCTInvalidating>
@end
...
- (BOOL)isMountedUnderScreenOrReactRoot
{
  for (UIView *parent = self.superview; parent != nil; parent = parent.superview) {
    if ([parent isKindOfClass:[ABI41_0_0RCTRootView class]] || [parent isKindOfClass:[RNSScreenView class]]) {
      return YES;
    }
  }
  return NO;
...
{
  // For RN touches to work we need to instantiate and connect ABI41_0_0RCTTouchHandler. This only applies
...
ABI41_0_0RCT_EXPORT_VIEW_PROPERTY(replaceAnimation, RNSScreenReplaceAnimation)
ABI41_0_0RCT_EXPORT_VIEW_PROPERTY(stackPresentation, RNSScreenStackPresentation)
ABI41_0_0RCT_EXPORT_VIEW_PROPERTY(stackAnimation, RNSScreenStackAnimation)
...
@implementation ABI41_0_0RCTConvert (RNSScreen)

ABI41_0_0RCT_ENUM_CONVERTER(RNSScreenStackPresentation, (@{
...
ABI41_0_0RCT_ENUM_CONVERTER(RNSScreenStackAnimation, (@{
...
ABI41_0_0RCT_ENUM_CONVERTER(RNSScreenReplaceAnimation, (@{
