#import "ABI41_0_0RNSScreenStack.h"
...
#import <ABI41_0_0React/ABI41_0_0RCTRootContentView.h>
#import <ABI41_0_0React/ABI41_0_0RCTTouchHandler.h>

@interface ABI41_0_0RNSScreenStackView () <UINavigationControllerDelegate, UIAdaptivePresentationControllerDelegate, UIGestureRecognizerDelegate>
...
@implementation ABI41_0_0RNScreensNavigationController
...
@interface ABI41_0_0RNSScreenStackAnimator : NSObject <UIViewControllerAnimatedTransitioning>
- (instancetype)initWithOperation:(UINavigationControllerOperation)operation;
@end

@implementation ABI41_0_0RNSScreenStackView {
  UINavigationController *_controller;
  NSMutableArray<ABI41_0_0RNSScreenView *> *_ABI41_0_0ReactSubviews;
  __weak ABI41_0_0RNSScreenStackManager *_manager;
  BOOL _hasLayout;
  BOOL _invalidated;
}

- (instancetype)initWithManager:(ABI41_0_0RNSScreenStackManager*)manager
{
  if (self = [super init]) {
    _hasLayout = NO;
    _invalidated = NO;
    ...
    _controller = [[ABI41_0_0RNScreensNavigationController alloc] init];
...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
  ...
  [ABI41_0_0RNSScreenStackHeaderConfig willShowViewController:viewController animated:animated withConfig:config];
}
...
- (void)presentationControllerDidDismiss:(UIPresentationController *)presentationController
{
  ...
  if ([screenView isKindOfClass:[ABI41_0_0RNSScreenView class]]) {
    ...
    if (self.onFinishTransitioning) {
      ...
      // finish event to arrive later than onDismiss (see ABI41_0_0RNSScreen#notifyDismiss)
...
{
  ABI41_0_0RNSScreenView *screen;
  if (operation == UINavigationControllerOperationPush) {
    screen = (ABI41_0_0RNSScreenView *) toVC.view;
  } else if (operation == UINavigationControllerOperationPop) {
    screen = (ABI41_0_0RNSScreenView *) fromVC.view;
  }
  if (screen != nil && (screen.stackAnimation == ABI41_0_0RNSScreenStackAnimationFade || screen.stackAnimation == ABI41_0_0RNSScreenStackAnimationNone)) {
    return  [[ABI41_0_0RNSScreenStackAnimator alloc] initWithOperation:operation];
  }
  return nil;
}
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
  ...
  if (parent != nil) {
    ABI41_0_0RCTTouchHandler *touchHandler = [parent performSelector:@selector(touchHandler)];
    [touchHandler cancel];
    [touchHandler reset];
  }
  
  ABI41_0_0RNSScreenView *topScreen = (ABI41_0_0RNSScreenView *)_controller.viewControllers.lastObject.view;
...
- (void)insertReactSubview:(ABI41_0_0RNSScreenView *)subview atIndex:(NSInteger)atIndex
{
  if (![subview isKindOfClass:[ABI41_0_0RNSScreenView class]]) {
    ABI41_0_0RCTLogError(@"ScreenStack only accepts children of type Screen");
    return;
  }
...
- (void)removeReactSubview:(ABI41_0_0RNSScreenView *)subview
{
  subview.ABI41_0_0ReactSuperview = nil;
...
- (void)didMoveToWindow
{
  ...
  if (!_invalidated) {
    ...
    // to a window despite the fact it has been removed from the ABI41_0_0React Native view hierarchy.
    [self maybeAddToParentAndUpdateContainer];
  }
}
...
- (void)maybeAddToParentAndUpdateContainer
{
  ...
  if (!wasScreenMounted) {
    ...
    [self ABI41_0_0ReactAddControllerToClosestParent:_controller];
    [self updateContainer];
  }
}
...
- (void)setModalViewControllers:(NSArray<UIViewController *> *)controllers
{
  ...
  for (NSUInteger i = changeRootIndex; i < controllers.count; i++) {
    if ([_presentedModals containsObject:controllers[i]]) {
      ABI41_0_0RCTAssert(false, @"Modally presented controllers are being reshuffled, this is not allowed");
    }
  }

  __weak ABI41_0_0RNSScreenStackView *weakSelf = self;
  ...
  void (^finish)(void) = ^{
    ...
    __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_13_0
        ...
        BOOL shouldAnimate = lastModal && [next isKindOfClass:[ABI41_0_0RNSScreen class]] && ((ABI41_0_0RNSScreenView *) next.view).stackAnimation != ABI41_0_0RNSScreenStackAnimationNone;
  ...
  if (changeRootController.presentedViewController != nil
    ...
    BOOL shouldAnimate = changeRootIndex == controllers.count && [changeRootController.presentedViewController isKindOfClass:[ABI41_0_0RNSScreen class]] && ((ABI41_0_0RNSScreenView *) changeRootController.presentedViewController.view).stackAnimation != ABI41_0_0RNSScreenStackAnimationNone;
...
- (void)setPushViewControllers:(NSArray<UIViewController *> *)controllers
{
  ...
  BOOL firstTimePush = ![lastTop isKindOfClass:[ABI41_0_0RNSScreen class]];

  BOOL shouldAnimate = !firstTimePush && ((ABI41_0_0RNSScreenView *) lastTop.view).stackAnimation != ABI41_0_0RNSScreenStackAnimationNone;
  ...
  if (firstTimePush) {
    ...
    if (![controllers containsObject:lastTop]) {
      ...
      if ( ![_controller.viewControllers containsObject:top] && ((ABI41_0_0RNSScreenView *) top.view).replaceAnimation == ABI41_0_0RNSScreenReplaceAnimationPush) {
...
- (void)updateContainer
{
  ...
  for (ABI41_0_0RNSScreenView *screen in _ABI41_0_0ReactSubviews) {
    if (!screen.dismissed && screen.controller != nil) {
      if (pushControllers.count == 0) {
        // first screen on the list needs to be places as "push controller"
        [pushControllers addObject:screen.controller];
      } else {
        if (screen.stackPresentation == ABI41_0_0RNSScreenStackPresentationPush) {
          [pushControllers addObject:screen.controller];
        } else {
...
@implementation ABI41_0_0RNSScreenStackManager {
  NSPointerArray *_stacks;
}

ABI41_0_0RCT_EXPORT_MODULE()

ABI41_0_0RCT_EXPORT_VIEW_PROPERTY(onFinishTransitioning, ABI41_0_0RCTDirectEventBlock);

- (UIView *)view
{
  ABI41_0_0RNSScreenStackView *view = [[ABI41_0_0RNSScreenStackView alloc] initWithManager:self];
  if (!_stacks) {
...
- (void)invalidate
{
 for (ABI41_0_0RNSScreenStackView *stack in _stacks) {
...
@implementation ABI41_0_0RNSScreenStackAnimator {
...
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning>)transitionContext
{
  ...
  if (_operation == UINavigationControllerOperationPush) {
    ...
    screen = (ABI41_0_0RNSScreenView *)toViewController.view;
  } else if (_operation == UINavigationControllerOperationPop) {
    UIViewController* fromViewController = [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    screen = (ABI41_0_0RNSScreenView *)fromViewController.view;
  }

  if (screen != nil && screen.stackAnimation == ABI41_0_0RNSScreenStackAnimationNone) {
    return 0;
  }
