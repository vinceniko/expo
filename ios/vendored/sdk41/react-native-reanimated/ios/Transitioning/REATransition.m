...
{
  REATransitionType type = [ABI41_0_0RCTConvert REATransitionType:config[@"type"]];
  switch (type) {
...
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super init]) {
    ...
    _interpolation = [ABI41_0_0RCTConvert REATransitionInterpolationType:config[@"interpolation"]];
    _propagation = [ABI41_0_0RCTConvert REATransitionPropagationType:config[@"propagation"]];
  }
  return self;
}
