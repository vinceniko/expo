...
- (instancetype)initWithConfig:(NSDictionary *)config
{
  if (self = [super initWithConfig:config]) {
    _sequence = [ABI41_0_0RCTConvert BOOL:config[@"sequence"]];
    NSArray *transitions = [ABI41_0_0RCTConvert NSArray:config[@"transitions"]];
...
{
  if (self = [super initWithConfig:config]) {
    _animationType = [ABI41_0_0RCTConvert REATransitionAnimationType:config[@"animation"]];
  }
  return self;
}
