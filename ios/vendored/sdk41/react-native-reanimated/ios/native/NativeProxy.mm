...
std::shared_ptr<NativeReanimatedModule> createReanimatedModule(std::shared_ptr<CallInvoker> jsInvoker) {
  ...
  ABI41_0_0RCTUIManager *uiManager = reanimatedModule.nodesManager.uiManager;
...
module = std::make_shared<NativeReanimatedModule>(jsInvoker,
  ...
  [reanimatedModule.nodesManager registerEventHandler:^(NSString *eventName, id<ABI41_0_0RCTEvent> event) {
