...
- (void)configure:(NSDictionary *)config
{
  ...
  if (@available(iOS 13.4, *)) {
    bool enableTrackpadTwoFingerGesture = [ABI41_0_0RCTConvert BOOL:config[@"enableTrackpadTwoFingerGesture"]];
  ...
  if (prop != nil) {
    CGFloat dist = [ABI41_0_0RCTConvert CGFloat:prop];
    recognizer.minDistSq = dist * dist;
  }
  
  prop = config[@"minVelocity"];
  if (prop != nil) {
    CGFloat velocity = [ABI41_0_0RCTConvert CGFloat:prop];
