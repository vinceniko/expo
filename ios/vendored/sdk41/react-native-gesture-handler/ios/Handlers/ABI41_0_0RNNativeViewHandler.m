//
//  ABI41_0_0RNNativeViewHandler.m
...
#import "ABI41_0_0RNNativeViewHandler.h"
...
#pragma mark ABI41_0_0RNDummyGestureRecognizer

@implementation ABI41_0_0RNDummyGestureRecognizer
...
#pragma mark ABI41_0_0RNNativeViewgestureHandler

@implementation ABI41_0_0RNNativeViewGestureHandler {
...
- (instancetype)initWithTag:(NSNumber *)tag
{
    if ((self = [super initWithTag:tag])) {
        _recognizer = [[ABI41_0_0RNDummyGestureRecognizer alloc] init];
    }
    return self;
}
...
- (void)configure:(NSDictionary *)config
{
    ...
    _shouldActivateOnStart = [ABI41_0_0RCTConvert BOOL:config[@"shouldActivateOnStart"]];
    _disallowInterruption = [ABI41_0_0RCTConvert BOOL:config[@"disallowInterruption"]];
}
...
- (void)bindToView:(UIView *)view
{
    ...
    // is set
    if ([view isKindOfClass:[ABI41_0_0RCTScrollView class]]) {
        // This part of the code is coupled with RN implementation of ScrollView native wrapper and
        // we expect for ABI41_0_0RCTScrollView component to contain a subclass of UIScrollview as the only
        // subview
...
- (void)handleTouchDown:(UIView *)sender forEvent:(UIEvent *)event
{
    ...
    [self sendEventsInState:ABI41_0_0RNGestureHandlerStateActive
             forViewWithTag:sender.ABI41_0_0ReactTag
              withExtraData:[ABI41_0_0RNGestureHandlerEventExtraData forPointerInside:YES]];
}

- (void)handleTouchUpOutside:(UIView *)sender forEvent:(UIEvent *)event
{
    [self sendEventsInState:ABI41_0_0RNGestureHandlerStateEnd
             forViewWithTag:sender.ABI41_0_0ReactTag
              withExtraData:[ABI41_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
...
{
    [self sendEventsInState:ABI41_0_0RNGestureHandlerStateCancelled
             forViewWithTag:sender.ABI41_0_0ReactTag
              withExtraData:[ABI41_0_0RNGestureHandlerEventExtraData forPointerInside:NO]];
}
