...
exports.kernelFilesTransforms = void 0;
/**
 ...
 */
function kernelFilesTransforms(versionName, rollback = false) {
    return {
        transforms: [
            {
...
exports.kernelFilesTransforms = kernelFilesTransforms;
/**
 ...
 */
function withRollback(rollback, replacement, rollbackReplacement) {
    return rollback ? rollbackReplacement !== null && rollbackReplacement !== void 0 ? rollbackReplacement : { replace: replacement.with, with: '' } : replacement;
}
//# sourceMappingURL=kernelFilesTransforms.js.map