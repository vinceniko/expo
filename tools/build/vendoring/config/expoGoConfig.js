            ...
            ios: {
                ...
                mutatePodspec(podspec) {
                    ...
                    [podspec.pod_target_xcconfig, podspec.xcconfig].forEach((xcconfig) => {
                        xcconfig.HEADER_SEARCH_PATHS = xcconfig.HEADER_SEARCH_PATHS.replace('/RCT-Folly', '/Folly');
                    });
                    // Fix compiler flags
                    podspec.compiler_flags = podspec.compiler_flags.replace('RNVERSION=64', 'RNVERSION=63');
                    podspec.xcconfig.OTHER_CFLAGS = podspec.xcconfig.OTHER_CFLAGS.replace('RNVERSION=64', 'RNVERSION=63');
                },
            },
        },
                    ...
                    content: [
                        {
                            ...
                            replaceWith: '- (WKProcessPool *)sharedProcessPoolForExperienceId:(NSString *)experienceId;',
                        },
                        {
                            paths: 'RNCWKProcessPoolManager.m',
                            find: 'WKProcessPool *_sharedProcessPool;',
                            replaceWith: 'WKProcessPool *_sharedProcessPool;\n    NSMutableDictionary<NSString *, WKProcessPool *> *_pools;',
                        },
                        {
                            paths: 'RNCWKProcessPoolManager.m',
...
//# sourceMappingURL=expoGoConfig.js.map